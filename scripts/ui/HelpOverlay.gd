...
func _help_text() -> String:
	return "%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s" % [
		Locale.t("help.title"),    Locale.t("help.move"),
		Locale.t("help.pitch_yaw"),Locale.t("help.roll"),
		Locale.t("help.vertical"), Locale.t("help.editor"),
		Locale.t("help.place"),    Locale.t("help.management"),
		Locale.t("help.build_mine"),Locale.t("help.free_cam"),
		Locale.t("help.map"),      Locale.t("help.warp"),
		Locale.t("help.weapons"),  Locale.t("help.dock"),
		Locale.t("help.ship_reactor"),Locale.t("help.quit"),
