...
var moon_display_name:  String = ""   # Wird von WorldManager gesetzt
var _angle_deg: float = 0.0
var _speed_deg: float = 20.0

func _ready() -> void:
	# Gruppe sofort setzen – SOITracker findet den Mond ab dem nächsten Frame
	add_to_group("moons")
